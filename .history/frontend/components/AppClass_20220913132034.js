  ...
  // You can delete them and build your own logic from scratch.
   ...
   getXY() {
    ...
    if(this.state.index === 0){
      this.setState({message: "(1,1)"})
      console.log(this.state.message)
      
    }
    else if(this.state.index === 1){
      this.setState({message: "(2,1)"})
      console.log(this.state.message)
    }
    else if(this.state.index === 2){
      this.setState({message: "(3,1)"})
      console.log(this.state.message)
    }
    else if(this.state.index === 3){
      this.setState({message: "(1,2)"})
      console.log(this.state.message)
    }
      ...
      this.setState({message: "(3,2)"})
      console.log(this.state.message)
    }
    else if(this.state.index === 6){
      this.setState({message: "(1,3)"})
      console.log(this.state.message)
    }
    else if(this.state.index === 7){
      this.setState({message: "(2,3)"})
      console.log(this.state.message)
    }
    else if(this.state.index === 8){
      this.setState({message: "(3,3)"})
      console.log(this.state.message)
    }
  }
