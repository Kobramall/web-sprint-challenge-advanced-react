  ...
  move = (evt) => {
   ...
   componentDidUpdate(prevProps, prevState) {
    if (prevState.index !== this.state.index) {
      this.setState({...this.state, message: this.getXY(), steps: this.state.steps < 1 ? (this.state.steps + 1): 0, x:this.setX(), y:this.setY()})
      console.log("Here", this.state.x, this.state.y)
    }
  }
